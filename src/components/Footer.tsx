...
const Footer = () => (
  <footer className="bg-white text-black py-16 overflow-hidden">
    <div className="container mx-auto px-4">
      ...
      >
        <p className="text-sm text-green-600">© {new Date().getFullYear()} BookMyJunk.com — Certified E-Waste Recycling Company in India</p>
        <p className="text-xs text-green-600">E-waste disposal services in India | Electronic scrap recycling service</p>
      </motion.div>
    </div>
  </footer>
);
